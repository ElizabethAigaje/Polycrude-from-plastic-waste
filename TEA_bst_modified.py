...
class TEA:
    ...
    **Abstract methods**
    ...
    depreciation_schedules: dict[tuple(str, int), NDArray[np.float64]] = { # type: ignore
    ...
    def __init__(self, system: System, IRR: float, duration: tuple[int, int], 
                ...
                finance_years: int, finance_fraction: float, system_add_OPEX: float=0.0):
        ...
        self.sytem_add_OPEX: float = system_add_OPEX
    ...
    def utility_cost(self) -> float:
        ...
        return self.system.utility_cost + self.system_add_OPEX*24*self.operating_days   #modified *24*self.operating_days
